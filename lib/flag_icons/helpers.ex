defmodule FlagIcons.Helpers do
  @moduledoc """
  Helper functions, like lookup by country code, etc.
  """
  ...
  @codes [
    ...
    %{name: "Australia", alpha2: "AU", alpha3: "AUS", numeric: "016"},
    ...
    %{name: "Cocos Islands", alpha2: "CC", alpha3: "CCK", numeric: "166"},
    %{name: "Democratis Republic of Congo", alpha2: "CD", alpha3: "COD", numeric: "180"},
    ...
    %{name: "Cook Island", alpha2: "CK", alpha3: "COK", numeric: "184"},
    ...
    %{name: "Faroe Island", alpha2: "FO", alpha3: "FRO", numeric: "234"},
    ...
    %{name: "French Polyesia", alpha2: "PF", alpha3: "PYF", numeric: "258"},
    %{name: "Papua New Guinea", alpha2: "PG", alpha3: "PNG", numeric: "598"},
    %{name: "Phillippines (the)", alpha2: "PH", alpha3: "PHL", numeric: "608"},
    ...
    %{
      name: "Saint Helena, Ascension Island, Traistan da Cunha",
      alpha2: "SH",
      alpha3: "SHN",
      numeric: "654"
    },
    %{name: "Slovenia", alpha2: "SI", alpha3: "SVN", numeric: "705"},
    %{name: "Svalbard, Jan Mayen", alpha2: "SJ", alpha3: "SJM", numeric: "744"},
    ...
    %{name: "Syrian Arab Republic (the)", alpha2: "SY", alpha3: "SYR", numeric: "760"},
    ...
    %{name: "Tanzania, the United Republic of", alpha2: "TZ", alpha3: "TZA", numeric: "834"},
    ...
    %{name: "Union of South American Nations", alpha2: "UNASUR"},
    ...
    # Other divisions, orgs or non-recognized countries...
    %{name: "England", alt: "GB-ENG"},
    %{name: "Northern Ireland", alt: "GB-NIR"},
    %{name: "Scotland", alt: "GB-SCT"},
    %{name: "Wales", alt: "GB-WLS"},
    %{name: "Catalonia", alt: "ES-CT"},
    %{name: "Galicia", alt: "ES-GA"},
    %{name: "Basque Country", alt: "ES-PV"},
    %{name: "Kosovo", alt: "XK"},
    %{name: "Bonaire", alt: "BQ"},
    %{name: "Diego Garcia", alt: "DG"},
    %{name: "Ascension Island", alt: "AC"},
    %{name: "Saint Helena", alt: "TA"},
    %{name: "Canary Islands", alt: "IC"},
    %{name: "Mayotte", alt: "YT"},
    %{name: "United Nations", alt: "UN"},
    %{name: "European Union", alt: "EU"},
    %{name: "Central European Free Trade Agreement", alt: "CEFTA"},
    %{name: "Arab League", alt: "ARAB"},
    %{name: "African Union", alt: "AFRUN"},
    %{name: "East African Community", alt: "EAC"},
    %{name: "Pacific Community", alt: "PC"},
    %{name: "Unknown", alt: "XX"}
  ]

  def codes, do: @codes

  def get_country_name_by_code!(""), do: nil
  def get_country_name_by_code!(nil), do: nil

  def get_country_name_by_code!(code) when is_binary(code) do
    code = String.upcase(code) |> String.replace("_", "-")

    case Enum.find(codes(), &(alpha2(&1) == code or alpha3(&1) == code or alt_code(&1) == code)) do
      nil -> raise KeyError, "Unknown country code: #{code}"
      country -> Map.get(country, :name, "")
    end
  end

  def get_country_name_by_code!(code) when is_atom(code) do
    to_string(code) |> get_country_name_by_code!()
  end

  defp alpha2(country), do: Map.get(country, :alpha2, "")
  defp alpha3(country), do: Map.get(country, :alpha3, "")
  defp alt_code(country), do: Map.get(country, :alt, "")
end
