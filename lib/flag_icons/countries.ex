defmodule FlagIcons.Countries do
  @moduledoc """
  Country helper functions, like lookup by country code.
  """
  ...
  def all, do: @country_codes

  # def country_name_by_code(code) when is_binary(code) do
  #   code = String.upcase(code)

  #   all()
  #   |> Enum.find(&(alpha2(&1) == code or alpha3(&1) == code))
  #   |> Map.get(:country_name)
  # end

  # def country_name_by_code(code) when is_atom(code) do
  #   to_string(code) |> country_name_by_code()
  # end

  # defp alpha2(country), do: Map.get(country, :alpha2, "")
  # defp alpha3(country), do: Map.get(country, :alpha3, "")
end
